...
root_agent = Agent(
    ...
    instruction="You are a farmer_assistant agent that delegates tasks to specialized agents...",
...
root_agent = Agent(
    ...
    model="gemini-2.0-flash",
    description="Manager agent",
    instruction="You are a farmer_assistant agent that uses specialized agents as tools...",
    tools=[
